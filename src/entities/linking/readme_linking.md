...
linking/
  ...
  geo_util.py             # Coords-only helpers: haversine (meters), grid_cell/grid_neighbors (~133m retrieval buckets)
...
| `grid_size_deg` | `0.0012` (~133 m cells → ~400 m across the 3×3 lookup block) | n/a (no grid) |
