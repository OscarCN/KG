...
- Roadmap / design TODOs live in `docs/todos/`, **one self-contained file per TODO** (e.g. `docs/todos/retrieval_linking_per_supertype.md`). When adding a TODO, create its own file there and link it from the Roadmap / TODOs section of README.md. Do not collect multiple TODOs into a single file.
